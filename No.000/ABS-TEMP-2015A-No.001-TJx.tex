...
\title{{\H The videos about reading the rules for laboratory}\quad {ABS-TEMP-2015A-No.001-TJx}}
\author{(Ji TANG)\\
               Number: ABS-TEMP-2015A-No.001-TJx,  E-mail: tangji08@hotmail.com \\
        Date: 2015.11.16}
...
\fancyhead[RO,LE]{ABS-TEMP-2015A-No.001-TJx}   %  请设置正确的个人文档编号
...
\section{\H Reading the rules for laboratory}
\subsection{Sending the videos}
This afternoon,Li Ye and me went to the laboratory 502 and read the rules over the wall.Then I'll send the video to you.

The two video's names are:

"ABS-TEMP-2015A-RULES-TJx.mov"

"ABS-TEMP-2015B-RULES-YLx.mov"
\section{\H Postscript}
\subsection{About one key}
I need to go to the laboratory tonight at 6:00pm, but the key was in his hand. So I need to ask him for the key. There are two students with only one key, which is too inconvenient. And Binghui Wang have two keys in his hand now, so maybe we could get one more key from him, which looks like more rational?

Thanks a lot, yours student Ji Tang.
...
\H http://www.zhihu.com/question/20822713
