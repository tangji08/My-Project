...
\title{{\H Weekly Report of Research Work\\ }\quad {WR-ABS-TEMP-2015A-No.011}}
\author{汤吉(Ji TANG)\\
...
\fancyhead[RO,LE]{WR-ABS-TEMP-2015A-No.011-TJx}   %  请设置正确的个人文档编号
...
\begin{enumerate}
	...
	\item Copying the book for English Writing
	\item Having the New Year Family dinner
\end{enumerate}
