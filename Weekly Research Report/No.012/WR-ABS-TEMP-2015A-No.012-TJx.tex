...
\title{{\H Weekly Report of Research Work\\ }\quad {WR-ABS-TEMP-2015A-No.012}}
\author{汤吉(Ji TANG)\\
               Number: WR-ABS-TEMP-2015A,  E-mail: tangji08@hotmail.com \\
        Date: 07/2/2016 - 14/2/2016}
...
\fancyhead[RO,LE]{WR-ABS-TEMP-2015A-No.012-TJx}   %  请设置正确的个人文档编号
...
\section{\H Work}
\begin{enumerate}
	\item Reading the elegant book "How to write mathematics ..."
	\item Renting a new virtual server in USA and trying to use it to run my program.
	\item Learning how to use GPU to speed up my program.
	\item Having a long talk with my family about my plan next year.
\end{enumerate}

\section{\H Read the book}
I have read a half of the book, but it's very hard to memorize the English texts. (Every day, I just spend the night reading one page. Maybe it's not the good time for reading.)

\section{\H VPS in USA}
Because building the neural network takes a large number of workloads, so I have tried to use my VPS to finish this work. But actually, the VPS I rent works slower than my computer.

\section{\H My plan}
Based on the current situation, my father thinks that I can't squeeze more time to prepare the new big exam for the other university especially preparing the different field of study. He said that I should be reality, the most important thing is what I can do not what I have learned. Maybe I could try something during the study.

So I'm preparing the interview for the practice of "Alibaba" this summer for operation and management, but I'm not sure whether it works.
