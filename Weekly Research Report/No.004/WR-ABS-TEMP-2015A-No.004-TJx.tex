...
\title{{\H 第一次信号处理作业\\ }}
\author{汤吉(Ji TANG)-121143325\\
               Number: 121143325,  E-mail: tangji08@hotmail.com }
        \date{\Today}
...
\fancyhead[RO,LE]{121143325-汤吉}   %  请设置正确的个人文档编号
...
%%*************************************************
\section{\H 离散信号图像}
	x(n) = Aexp(cn)，其中A=5,N=20.
c取值分别为：c=[2+5j     -1+5j     2+50j    -1+50j]。

\includegraphics[scale=1]{../../../Users/汤吉/Documents/大四上/determinate signal processing/汤吉-121143325/第一次作业/1.jpg} 
%%****************************************
%%  参考文献
%%****************************************
